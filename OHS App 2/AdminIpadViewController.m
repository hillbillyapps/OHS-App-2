...
#import "AdminIpadViewController.h"

@interface AdminIpadViewController ()

@end

@implementation AdminIpadViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"http://www.baylife.me/mobile/admin/"];
